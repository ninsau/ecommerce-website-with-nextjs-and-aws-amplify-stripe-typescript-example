                ...
                <div className="max-w-2xl mx-auto py-24 lg:py-64 lg:max-w-none">
                  <div className="lg:pr-16">
                    ...
                    <p className="mt-4 text-xl text-gray-600">
                      All the charts, datepickers, and notifications in the world cant beat checking off some items on
                      a paper card.
                    </p>
                    <div className="mt-6">
                      <a
          ...
          >
            <div className="max-w-2xl mx-auto lg:max-w-none">
              ...
              <p className="mt-4 max-w-xl mx-auto text-xl text-gray-600">
                Most of our products are limited releases that won come back. Get your favorite items while theyre in
                stock.
              </p>
              <a
                href="#"
