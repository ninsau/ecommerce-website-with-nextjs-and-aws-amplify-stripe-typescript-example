                        ...
                        <div className="flow-root">
                          ...
                          >
                            {products && products.length > 0 ? (
                              <>
                                {products?.map(
                                  (product: CartContentType, i: number) => (
                              ...
                              <div className="text-center">
                                ...
                                <div className="mt-6">
                                  <Link href="/">
                                    <div className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                      <PlusIcon
