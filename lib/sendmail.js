...
import { BRAND_IMAGE, BRAND_NAME, BRAND_URL } from ".";
AWS.config.update({
  accessKeyId: process.env.FOSUAA.AWS_ACCESS_KEY,
  secretAccessKey: process.env.FOSUAA.AWS_SECRET_ACCESS_KEY,
  region: "us-east-1",
});
    ...
    <tr>
      <td style="padding-left: 24px; padding-right: 24px; text-align: center; font-size: 12px; color: #4b5563;">
        <p style="margin: 0; margin-bottom: 4px; text-transform: uppercase;">Powered by
          <a href="https://ohmysmtp.com/" class="hover-underline" style="color: #3b82f6; text-decoration: none;">OhMySMTP</a>
        </p>
